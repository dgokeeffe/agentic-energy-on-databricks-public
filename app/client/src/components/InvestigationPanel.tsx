    ...
    <Card className="investigation-card">
      <CardHeader>
        ...
        <CardDescription>
          ...
          follow-up note. Check the source freshness before drawing conclusions.
        </CardDescription>
      </CardHeader>
      <form onSubmit={(event) => void submit(event)}>
        <CardContent className="investigation-form">
          <Button type="button" variant="outline" onClick={() => {
            ...
            {analysisShown ? 'Refresh prepared analysis' : 'Prepare an investigation note'}
          </Button>
          {analysisShown && (
            <Alert>
              <AlertDescription>
                Prepared investigation checklist: the selected interval is suitable for investigation, but this evidence
