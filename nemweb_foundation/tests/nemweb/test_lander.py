...
from agentic_energy.nemweb.contracts import (
    ContractError,
    ModeIsolationError,
...
from agentic_energy.nemweb.parser import UnsafeArchiveError, ZipLimits, parse_zip_bytes
...
def test_context_cli_raises_only_context_zip_bound(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
    import agentic_energy.nemweb.lander as module
    captured = {}
    class FakeClient:
