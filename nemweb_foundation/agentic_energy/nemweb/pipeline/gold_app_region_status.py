...
def gold_nem_app_region_status():
    ...
    return (
        ...
        .select(
            ...
            F.lit(None).cast("string").alias("prediction_model_version"),
            F.lit(None).cast("timestamp").alias("prediction_feature_time"),
            F.lit(None).cast("timestamp").alias("prediction_scored_at"),
            F.lit(None).cast("string").alias("prediction_source_freshness"),
            F.lit(None).cast("string").alias("prediction_missing_feature_status"),
        )
    )
