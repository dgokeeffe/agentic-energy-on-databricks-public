...
| Historical work item | `agentic-energy-zwh` — Engineering: inspect and improve the metadata contract |
...
[`../facilitator/workshop-acceptance.md`](../facilitator/workshop-acceptance.md) and the *operational
